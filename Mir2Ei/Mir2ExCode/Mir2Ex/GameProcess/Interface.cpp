...
VOID CInterface::ShowGameStatus()
{
	...
	{
		RECT rcHP = { 0, LONG(m_pxInterImg->m_lpstNewCurrWilImageInfo->shHeight-(m_pxInterImg->m_lpstNewCurrWilImageInfo->shHeight*fMyHPRate)), 
	...
	{
		RECT rcMP = { 0, LONG(m_pxInterImg->m_lpstNewCurrWilImageInfo->shHeight-(m_pxInterImg->m_lpstNewCurrWilImageInfo->shHeight*fMyMPRate)), 
					  m_pxInterImg->m_lpstNewCurrWilImageInfo->shWidth, m_pxInterImg->m_lpstNewCurrWilImageInfo->shHeight };
	...
	{
		RECT rcEXP = { 0, LONG(m_pxInterImg->m_lpstNewCurrWilImageInfo->shHeight-(m_pxInterImg->m_lpstNewCurrWilImageInfo->shHeight*fMyExpRate)), 
					   m_pxInterImg->m_lpstNewCurrWilImageInfo->shWidth, m_pxInterImg->m_lpstNewCurrWilImageInfo->shHeight };
	...
	{
		RECT rcWET = { 0, LONG(m_pxInterImg->m_lpstNewCurrWilImageInfo->shHeight-(m_pxInterImg->m_lpstNewCurrWilImageInfo->shHeight*fMyWetRate)), 
					  m_pxInterImg->m_lpstNewCurrWilImageInfo->shWidth, m_pxInterImg->m_lpstNewCurrWilImageInfo->shHeight };
...
BOOL CInterface::OnLButtonDown(POINT ptMouse)
{
	...
	else
	{
		if ( m_xScrlBar.OnLButtonDown(ptMouse) )
		{
			...
			m_nFstLine  = INT((m_xChat.GetCounter()-1)*fScrlRate);
